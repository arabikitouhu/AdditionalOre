...
public class ItemDust extends Item {
	...
	public static final String[] uniNames = {
		...
		"Diamond", "Quartz", "Copper", "Tin",
		"Uranium", "Aluminium", "Bronze", "Steel",
		"Titanium", "Lead", "Nickel", "Silver",
		"Chrome", "Tungsten", "Iridium" };
	public static final String[] jpNames = {
		"\u77F3\u70AD\u306E\u7C89", "\u9244\u306E\u7C89", "\u91D1\u306E\u7C89", "\u30A8\u30E1\u30E9\u30EB\u30C9\u306E\u7C89",
		"\u30C0\u30A4\u30E4\u30E2\u30F3\u30C9\u306E\u7C89", "\u77F3\u82F1\u306E\u7C89", "\u9285\u306E\u7C89", "\u932B\u306E\u7C89",
		"\u30A6\u30E9\u30CB\u30A6\u30E0\u306E\u7C89", "\u30A2\u30EB\u30DF\u30CB\u30A6\u30E0\u306E\u7C89", "\u9752\u9285\u306E\u7C89", "\u92FC\u306E\u7C89",
		"\u30C1\u30BF\u30CB\u30A6\u30E0\u306E\u7C89", "\u925B\u306E\u7C89", "\u30CB\u30C3\u30B1\u30EB\u306E\u7C89", "\u9280\u306E\u7C89",
		"\u30AF\u30ED\u30E0\u306E\u7C89", "\u30BF\u30F3\u30B0\u30B9\u30C6\u30F3\u306E\u7C89", "\u30A4\u30EA\u30B8\u30A6\u30E0\u306E\u7C89"};
	...
	public String getUnlocalizedName(ItemStack itemStack) {
		...
		return "additionalOre:" + uniNames[meta] + " Dust";
	}
	...
	public void registerIcons(IconRegister iconRegister) {
		...
		for (int i = 0; i < uniNames.length; i++) {
			icons[i] = iconRegister.registerIcon("additionalOre:" + uniNames[i] + " Dust");
		}
